 ...
 * @public
 */
Iamporter.prototype.getPreparedPayment = function (form) {
  var _this = this;
  var spec = {
    method: 'GET',
    path: ['payments', 'prepare', ':merchant_uid'],
    requiredParams: ['merchant_uid']
  };
 ...
 * @public
 */
Iamporter.prototype.getPreparedPaymentByMerchantUid = function (merchantUid) {
  var _this = this;
  var spec = {
    method: 'GET',
